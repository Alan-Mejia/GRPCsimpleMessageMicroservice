...
public class InvoiceRest {
    ...
    public String/*ResponseEntity<String>*/ getTest(@PathVariable String value) {
    	
        return  helloService.sendMessage(value)/*ResponseEntity.ok(helloService.sendMessage("ok"))*/;
    }
